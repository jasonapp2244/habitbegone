...
class OsteopathyView extends StatefulWidget {
  const OsteopathyView({super.key});

  @override
  State<OsteopathyView> createState() => _OsteopathyViewState();
}

class _OsteopathyViewState extends State<OsteopathyView> {
  File? _selectedFile;
...
// class OsteopathyView extends StatelessWidget {
//   const OsteopathyView({super.key});
