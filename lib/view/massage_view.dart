...
class MassageTherapyView extends StatefulWidget {
  const MassageTherapyView({super.key});

  @override
  State<MassageTherapyView> createState() => _MassageTherapyViewState();
}

class _MassageTherapyViewState extends State<MassageTherapyView> {
  File? _selectedFile;
...
// class MassageTherapyView extends StatelessWidget {
//   const MassageTherapyView({super.key});
